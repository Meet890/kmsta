...
<body>
    ...
    <div class="container-box">
        ...
        <div class="profile-wrapper">
            <img src="../user/logged/uploads/<?php echo ($searchUserProfile ?? 'default2.png'); ?>">

            <div>
                <div class="username"><?php echo $searchUserName; ?></div>

                <form method="post">
                    <input type="hidden" name="follow_id" value="<?php echo $acc_id; ?>">
                    ...
                    <p class="bio"><?php echo $searchUserBio; ?>
                    </p>
            </div>
        </div>
        ...
        <div class="gallery">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    $caption = $row['caption'] ?? '';
                    $file_path = "../user/logged/uploads/" . $post_file;
